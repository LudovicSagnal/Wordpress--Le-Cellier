...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Wordpress_cellier_cb37bb141e2434762869_20230106092618_archive.zip';
        const ARCHIVE_SIZE       = '71867159';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'cb37bb1-06092618';
        const SECONDARY_PACKAGE_HASH = '7733953-06092618';
        const VERSION            = '1.5.1';
